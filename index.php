                        ...
                        <form id="frm">
                            <div class="row" align="center">
                                <div class="col-lg-6" style="margin-top: 5%;" align="end">
                                    <a href="index.php" style="text-decoration: none; padding:10px; background-color:#E7B10A; color:black; border-radius: 10px; font-weight:600">Student Login</a>
                                </div>
                                <div class="col-lg-6" style="margin-top: 5%;" align="start">
                                    <a href="facultyloginpage.php" style="text-decoration: none; padding:10px; border: 2px solid #E7B10A; color:black; border-radius: 10px; font-weight:600">Faculty Login</a>
                                </div>
                            </div>
                            ...
                            <button type="submit" name="submit" id="eee" class="btn btn-primary mt-2 mb-4" style="color: black; background-color:#E7B10A; border:none; width:100px; font-weight:600">Submit</button>
                        </form>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
                ...
                $.ajax({
                    ...
                    beforeSend:()=>{
                        ...
                        if(res == "upasstpassppass"){
                            location.replace("studentpanel.php");
                        }else if(res == "upassppass"){
                            $("#passworderror").html("Please login in Faculty page");
